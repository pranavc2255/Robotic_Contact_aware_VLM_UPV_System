...
- Projected endpoint quantiles: `0.0025` / `0.9975`.
...
- Anchors with valid depth point-cloud path length: 100
- Anchors with invalid depth point-cloud path length: 2
- Top all-anchor depth point-cloud failure reasons: `{'missing_reference_depth': 2}`
...
Across all selected paths with valid depth point-cloud estimates, the lower MAE method is: **depth point-cloud-based**.

## Invalid Selected Depth Point-Cloud Rows
None.

Selected-path depth point-cloud failure reason counts: `{}`
...
- Diagnostic figures: `workspace/outputs/final_path_results_v2_percentile_endpoint_mask_depth_eval/session_20260705_135701/figures`